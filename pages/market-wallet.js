import ActiveBid from "@/components/sections/Lanzamientos"
import Collection from "@/components/sections/MisActivos"
import Create from "@/components/sections/Create"
import Explore from "@/components/sections/Finanzas"
import Favourite from "@/components/sections/Favorite"
                            ...
                            <div className="admin_active" id="header_admin">
                                <div className="popup-notification relative">
                                    ...
                                    <div className={`avatar_popup ${isToggled2 ? "visible" : ""}`}>
                                        <h5 className="mb-30">Notificaciones</h5>
                                ...
                                <div className="popup-user relative">
                                    <div className="user" onClick={handleToggle}>
                                        ...
                                        <span>Perfil<i className="icon-keyboard_arrow_down" /></span>
                                    </div>
                        ...
                        <div className={`section-menu-left ${isMobileSidebar ? "null" : ""}`}>
                          ...
                          {/*  <div className="create menu-tab">
                            ...
                            <div className="bottom">
                                <p style={{ fontSize: '11px'}}>POWERED BY DREAMHUB</p>
                            </div>
                        </div>
