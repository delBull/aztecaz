                ...
                <div className="themesflat-container">
                    ...
                    <div className="row">
                        <div className="col-12">
                            <a href={`${process.env.NEXT_PUBLIC_DASHBOARD_URL ? process.env.NEXT_PUBLIC_DASHBOARD_URL + '/dashboard/market' : 'http://localhost:3001/dashboard/market'}`} className="tf-button style-1 h50 w190 m-auto">¡Empieza ya!<i className="icon-arrow-up-right2" /></a>
                        </div>
                    </div>
