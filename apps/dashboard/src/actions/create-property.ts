...
const CreatePropertySchema = z.object({
    ...
    areaSqFt: z.coerce.number().optional().nullable(),
    ...
    electricalCapacity: z.string().optional().nullable(),
    floorLoad: z.coerce.number().optional().nullable(),
    frontage: z.coerce.number().optional().nullable(),
...
export async function createProperty(prevState: any, formData: FormData) {
    ...
    // First element of images array is the main image, rest are gallery
